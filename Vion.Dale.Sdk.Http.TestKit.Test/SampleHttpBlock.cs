...
namespace Vion.Dale.Sdk.Http.TestKit.Test
{
    ...
    public sealed class SampleHttpBlock : LogicBlockBase
    {
        ...
        {
            _client.GetJson<DeviceDescription>(this, url, description => Settled.Add((url, description)), exception => Settled.Add((url, exception)), timeout: timeout);
        }
        ...
        {
            _client.PostJson(this, url, status, () => Settled.Add((url, "posted")), exception => Settled.Add((url, exception)));
        }
        ...
        public void SendRaw(HttpRequestMessage request)
        {
            ...
            _client.SendRequest(this, request, response => Settled.Add((url, response)), exception => Settled.Add((url, exception)));
        }
