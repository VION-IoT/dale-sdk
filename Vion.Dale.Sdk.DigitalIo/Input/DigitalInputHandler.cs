...
namespace Vion.Dale.Sdk.DigitalIo.Input
{
    ...
    public partial class DigitalInputHandler : ServiceProviderHandlerBase
    {
        ...
        protected override void HandleMqttMessage(ServiceProviderMqttMessage message)
        {
            ...
            DiStatePayload payload;
            try
            {
                payload = message.GetJsonPayload(HwJsonContext.Default.DiStatePayload);
            }
        ...
        [LoggerMessage(Level = LogLevel.Debug, Message = "Rejected undecodable DI payload (ServiceProviderContractId={ServiceProviderContractId}, Topic={Topic})")]
