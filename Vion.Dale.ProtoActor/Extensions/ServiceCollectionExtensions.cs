...
{
    /// <summary>
    ///     The registration a host adds to spawn logic blocks onto an actor system.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>Registers the actor system a host spawns logic blocks onto, composed with <c>AddDaleSdk</c>.</summary>
