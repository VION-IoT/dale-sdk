...
namespace Vion.Dale.Sdk.AnalogIo.Test
{
    ...
    public class ProviderHandlerShould
    {
        ...
        public void DecodeNothingWhenMqttMessageArrives(ServiceProviderHandlerBase handler)
        {
            ...
            // Act
            _harness.Send(handler, HandlerHarness.MqttMessage(HandlerHarness.StateTopic(Topics.AiState), HandlerHarness.AnalogStatePayload(4.2)));
        ...
        public void PublishNothingWhenContractMessageArrives(ServiceProviderHandlerBase handler)
        {
            ...
            // Act
            _harness.Send(handler, new ContractMessage<SetAnalogOutput>(HandlerHarness.BlockContract, new SetAnalogOutput(4.2)));
        ...
        {
            yield return [new AnalogInputProviderHandler(NullLogger<AnalogInputProviderHandler>.Instance)];
            yield return [new AnalogOutputProviderHandler(NullLogger<AnalogOutputProviderHandler>.Instance)];
        }
    }
}