...
severity, each one fixed or accepted with its reason. The operator's dispositions ride as one
`review` line in `docs/process-journal.md`, in the commit that applies them. -->
