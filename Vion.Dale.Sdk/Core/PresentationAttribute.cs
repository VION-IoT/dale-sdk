...
namespace Vion.Dale.Sdk.Core
{
    ...
    public class PresentationAttribute : Attribute
    {
        ...
        ///     CLR type name. Translatable in the cloud under the member's title key (see the
        ///     remarks on <see cref="ServicePropertyAttribute" />).
        /// </summary>
        ...
        ///     A custom key is also the translation key of its section label — editing it orphans
        ///     that label's translations. Well-known <see cref="PropertyGroup" /> keys are
        ///     translated by the platform itself.
        /// </summary>
