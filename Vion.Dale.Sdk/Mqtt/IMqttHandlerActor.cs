...
namespace Vion.Dale.Sdk.Mqtt
{
    ...
    ///         <item>Can register themselves using <see cref="RegisterMqttHandler" /> (use extension methods in <see cref="MqttHandlerActorExtensions" /> for easier registration)</item>
    ...
    ///         <item>Use <see cref="PublishMqttMessageRequest" /> and <see cref="PublishMqttMessageResponse" /> to wait for confirmation that publishing succeeded or failed</item>
    ///     </list>
    /// </remarks>
