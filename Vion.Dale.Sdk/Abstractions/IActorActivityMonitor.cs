namespace Vion.Dale.Sdk.Abstractions
{
    ...
    ///     DevHost's deterministic-stepping barrier to know whether ANY user handler is currently
    ...
    ///         cannot see). This is the same opt-in pattern as <see cref="IActorMessageObserver" /> (the
    ///         development host's message tap) and <see cref="IDelayedSendGate" /> (the pause gate).
    ///     </para>
    /// </summary>
