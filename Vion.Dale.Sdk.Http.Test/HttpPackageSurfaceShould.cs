...
namespace Vion.Dale.Sdk.Http.Test
{
    ...
    public class HttpPackageSurfaceShould
    {
        ...
        public void PublishOnlyWhatBlockAuthorCalls()
        {
            ...
            // Assert
            Assert.AreEqual("ContentNullAfterDeserializationException,HttpClientSummary,HttpOutcome,HttpReceipt,HttpServerRequest,HttpServerResponse,HttpServerSummary,IHttpServerSnapshot,ILogicBlockHttpClient,ILogicBlockHttpServer,ILogicBlockHttpServerFactory,ServiceCollectionExtensions",
