...
{
    /// <summary>
    ///     The analyzer-wiring probe for <c>Vion.Dale.Sdk.DigitalIo.TestKit</c>: a public type in the kit's declared published
    ...
    /// </summary>
    public class DigitalIoTestKitPublicApiWiringProbe
    {
    }
}
