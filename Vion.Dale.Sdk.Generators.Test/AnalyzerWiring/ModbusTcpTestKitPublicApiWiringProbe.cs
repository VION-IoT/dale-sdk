...
{
    /// <summary>
    ///     The analyzer-wiring probe for <c>Vion.Dale.Sdk.Modbus.Tcp.TestKit</c>: a public type in the kit's declared published
    ...
    /// </summary>
    public class ModbusTcpTestKitPublicApiWiringProbe
    {
    }
}
